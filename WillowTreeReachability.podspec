#
#  Be sure to run `pod spec lint WTReachability.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/willowtreeapps/WillowTreeReachability.git", :tag => "2.0.4" }
